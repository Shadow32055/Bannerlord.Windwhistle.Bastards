...
namespace Bastards.StaticUtils
{
    public static class Conversation {
        ...
        public static void LegitimizeBastard() {
            ...
            float infNeeded = GlobalSettings<MCMSettings>.Instance.LegitimizeInfluenceCost;
        ...
        public static bool BastardConceptionAllowed() {
            ...
            if (!GlobalSettings<MCMSettings>.Instance.IncestEnabled && Utils.HerosRelated(Hero.MainHero, otherHero)) return false;
        ...
        public static void ConceiveBastard() {
            ...
            heroesAskedForConception[otherHero] = CampaignTime.DaysFromNow(GlobalSettings<MCMSettings>.Instance.AskedTimerInDays);
        ...
        public static void BecomeBastardOfHero() {
            ...
            if (GlobalSettings<MCMSettings>.Instance.SurnamesEnabled) {
