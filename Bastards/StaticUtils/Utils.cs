...
namespace Bastards.StaticUtils
{
    public static class Utils {
        ...
        public static bool GetIfHeroWouldConceiveBastard(Hero hero) {
            ...
            int chance = GlobalSettings<MCMSettings>.Instance.AIBaseConceptionChance;

            if (hero.Spouse != null) chance -= hero.GetRelation(hero.Spouse);

            if (GlobalSettings<MCMSettings>.Instance.TraitAffectedRelationEnabled) {
        ...
        public static int GetRelationNeededForConceptionAcceptance(Hero hero, Hero otherHero) {
            int relationNeeded = GlobalSettings<MCMSettings>.Instance.BaseRelationNeeded;
        ...
        public static bool PercentChanceCheck(int chanceOutOfHundred) {
            ...
            if (Bastards.Random.Next(1, 101) <= chanceOutOfHundred)
                return true;
            return false;
        }
